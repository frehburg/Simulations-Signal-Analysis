...
public class MainRand {
    public static void main(String[] args) throws Exception {
        UnifRandGenerator r = new LinCombCompositeGenerator((long) Math.pow(2,17),new UnifRandGenerator[]{new JUnifRandGenerator(), LCGUnifGenerator.RANDU},new long[]{1,5},0);
        completeTest(r);
    }
